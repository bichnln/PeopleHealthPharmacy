...
<html lang="en">
	...
	<div class="content">
		...
		<?php include 'menu.inc';?>
			...
			<form id="editForm" method="post" action="../controller/editinventory.php">
				<fieldset>
					<legend>Edit Inventory Record</legend>
						<p>
						...
						<p>
							...
							<input type="text" name="itemPrice" id="itemPrice" maxlength="8" size="10" pattern="([0-9])+(\.[0-9]{1,2})?" />
						</p>
						<p>
